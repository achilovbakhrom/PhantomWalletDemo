...
var _sockjs = require('./sockjs-0.3.4');
...
var connect = function connect() {
  ...
  return new Promise(function (resolve, reject) {
    var self = _this;
    if (!_sockjs.SockJS) self.socket = new _sockjsClient2.default(self.endpoint + '/w/messages');else self.socket = new _sockjs.SockJS(self.endpoint + '/w/messages');
